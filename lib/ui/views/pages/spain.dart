...
class _SpainState extends State<Spain>{
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_){
      ...
      footballProvider.fetchSpanishGoalStats(
          tokenProvider.token
      );
            ...
            switch(provider.spanishState){
              ...
              case ViewState.Retrieved:
                return Stack(
                  children: [
                    CustomBarChart(
                      goalStats: provider.spanishGoalStats,
                    ),
                    Positioned(
              ...
              case ViewState.Error:
                return Center(
                  child: ElevatedButton(
                      ...
                      onPressed: () => provider.fetchSpanishGoalStats(
                          tokenProvider.token
                      )),
                );
                break;
